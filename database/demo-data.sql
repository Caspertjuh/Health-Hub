...
-- Sample activities for current date
...
VALUES
('activity-fixed-1-user-1-today', 'template-fixed-1', 'user-1', 'Ontbijt', 'Ontbijt in de gemeenschappelijke ruimte', '08:00', '09:00', date('now'), 'Eetzaal', 'fixed', 'meal', 'utensils', '#FF9F1C', FALSE, 'easy'),
('activity-fixed-3-user-1-today', 'template-fixed-3', 'user-1', 'Lunch', 'Lunch in de gemeenschappelijke ruimte', '12:30', '13:30', date('now'), 'Eetzaal', 'fixed', 'meal', 'utensils', '#FF9F1C', FALSE, 'easy'),
('activity-flex-1-user-1-today', 'template-flex-1', 'user-1', 'Wandelen', 'Een rustige wandeling buiten', '10:00', '11:00', date('now'), 'Buiten', 'flexible', 'exercise', 'walking', '#98FB98', FALSE, 'easy'),
('activity-flex-6-user-1-today', 'template-flex-6', 'user-1', 'Tekenen', 'Creatieve tekenactiviteit', '14:00', '15:00', date('now'), 'Knutselruimte', 'flexible', 'creative', 'palette', '#FFB6C1', FALSE, 'easy'),
('activity-group-1-today', 'template-group-1', NULL, 'Spelletjesmiddag', 'Gezellig samen bordspellen spelen', '15:30', '17:00', date('now'), 'Activiteitenruimte', 'group', 'social', 'puzzle-piece', '#B0E0E6', FALSE, 'easy');

-- Required support for activities
INSERT OR IGNORE INTO activity_required_support (activity_id, language, planning, sensory, motor, social, cognitive) VALUES
('activity-fixed-1-user-1-today', FALSE, FALSE, FALSE, FALSE, FALSE, FALSE),
('activity-fixed-3-user-1-today', FALSE, FALSE, FALSE, FALSE, FALSE, FALSE),
('activity-flex-1-user-1-today', FALSE, FALSE, FALSE, TRUE, FALSE, FALSE),
('activity-flex-6-user-1-today', FALSE, FALSE, FALSE, TRUE, FALSE, FALSE),
('activity-group-1-today', FALSE, FALSE, FALSE, FALSE, TRUE, FALSE);

-- Set up group activity settings
INSERT OR IGNORE INTO group_activity_settings (activity_id, max_participants)
VALUES ('activity-group-1-today', 8);

-- Add user to group activity
INSERT OR IGNORE INTO group_activity_participants (activity_id, user_id)
VALUES ('activity-group-1-today', 'user-1');

-- Sample activities for tomorrow
INSERT OR IGNORE INTO activities (
    id, template_id, user_id, title, description, start_time, end_time, date, location, 
    category, type, icon, color, completed, difficulty
)
VALUES
('activity-fixed-1-user-1-tomorrow', 'template-fixed-1', 'user-1', 'Ontbijt', 'Ontbijt in de gemeenschappelijke ruimte', '08:00', '09:00', date('now', '+1 day'), 'Eetzaal', 'fixed', 'meal', 'utensils', '#FF9F1C', FALSE, 'easy'),
('activity-fixed-3-user-1-tomorrow', 'template-fixed-3', 'user-1', 'Lunch', 'Lunch in de gemeenschappelijke ruimte', '12:30', '13:30', date('now', '+1 day'), 'Eetzaal', 'fixed', 'meal', 'utensils', '#FF9F1C', FALSE, 'easy');

-- Required support for tomorrow's activities
INSERT OR IGNORE INTO activity_required_support (activity_id, language, planning, sensory, motor, social, cognitive) VALUES
('activity-fixed-1-user-1-tomorrow', FALSE, FALSE, FALSE, FALSE, FALSE, FALSE),
('activity-fixed-3-user-1-tomorrow', FALSE, FALSE, FALSE, FALSE, FALSE, FALSE);